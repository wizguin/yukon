...
class Town extends RoomScene {
    ...
    preload() {
        ...
        this.load.pack("halloween-town-pack", "assets/media/parties/halloween/town/halloween-town-pack.json");
    }

    _create() {

        // bg
        const bg = this.add.image(-109, -80, "town", "bg");
        bg.setOrigin(0, 0);
        ...
        // coffee_door
        const coffee_door = this.add.image(435, 305, "town", "coffee_door");
        coffee_door.setOrigin(0, 0);

        // gift_door
        const gift_door = this.add.image(995, 297, "town", "gift_door");
        gift_door.setOrigin(0, 0);

        // halloween_lights
        const halloween_lights = this.add.sprite(657, 281, "town", "halloween_lights/halloween_lights0001");
        halloween_lights.setOrigin(0, 0);
        ...
        // movie_sign
        const movie_sign = this.add.image(627, 158, "town", "movie_sign");
        movie_sign.setOrigin(0, 0);
        ...
        // chair_2
        const chair_2 = this.add.image(436, 465, "town", "chair_2");
        chair_2.setOrigin(0.49382716049382713, 0.27358490566037735);

        // table_2
        const table_2 = this.add.image(485, 526, "town", "table_2");
        table_2.setOrigin(0.5, 0.7864077669902912);

        // chair_1
        const chair_1 = this.add.image(402, 514, "town", "chair_1");
        chair_1.setOrigin(0.49411764705882355, 0.2857142857142857);

        // table_1
        const table_1 = this.add.image(455, 578, "town", "table_1");
        table_1.setOrigin(0.49572649572649574, 0.7830188679245284);

        // pumpkin
        const pumpkin = this.add.image(598, 429, "town", "pumpkin");
        pumpkin.setOrigin(0.4583333333333333, 0.5773195876288659);

        // disco_middle
        const disco_middle = this.add.image(801, 276, "town", "disco_middle");
        disco_middle.setOrigin(0, 0);
        ...
        // halloween_lights (components)
        const halloween_lightsAnimation = new Animation(halloween_lights);
        halloween_lightsAnimation.key = "halloween_lights/halloween_lights";
        halloween_lightsAnimation.end = 80;
