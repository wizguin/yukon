...
class PenguinLarge extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        username.setStyle({"align":"center","fixedWidth":420,"fontFamily":"Arial","fontSize":"44px","fontStyle":"bold italic","stroke":"#003366","strokeThickness":10,"shadow.color":"#000000ff"});
        this.add(username);
